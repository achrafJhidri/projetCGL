...
ajouterUneQuantite.addEventListener('click', (event)=>{
    ...
    const index =  tabFournitureProduits.find(element => element.id_fourniture === obj.id_fourniture);
    console.log(index);
    if(index === undefined)
    {
    ...
    {
        const confirm = confirm("Souhaitez-vous écraser l'ancienne quantité: oui pour écrase, non?")
    }

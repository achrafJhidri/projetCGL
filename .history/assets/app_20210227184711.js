...
btnEnregistrer.addEventListener('click', (event)=>{
    ...
    form.append('name', formSubmit.elements["produit[name]"].v )
    form.append('price', formSubmit.elements["produit[sellPrice]"] )
    form.append('gamme', formSubmit.elements["produit[gamme]"])
})
